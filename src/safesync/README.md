...
```sh
scripts/install/install-safesync.sh
```
...
```sh
cargo test --manifest-path src/safesync/Cargo.toml --locked
cargo clippy --manifest-path src/safesync/Cargo.toml --locked --all-targets -- -D warnings
```
