...
topaz_enhancement_preset_rows() {
  ...
  print -r -- $'upscale-2x\tGaia HQ 2x\tgaia-hq-2x\ttvai_up=model=ghq-5:scale=2:device=0:vram=0.95:instances=1\tClean, smooth 2x; great for CG / animation\tvideoai=[Upscale 2x] Gaia HQ. Clean, smooth, low-noise 2x upscale. Softer and more poster-like than Proteus; great for graphics, animation, CG and already-clean footage.'
