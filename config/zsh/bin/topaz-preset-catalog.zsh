...
topaz_transform_preset_rows() {
  ...
  print -r -- $'[Starlight Mini] Upscale 2x\tUpscale, Enhance\tstarlight-mini-upscale-2x\ttvai_up=model=slm-1:scale=2:device=0:vram=0.95:instances=1\tvideoai=[Starlight Mini] Upscale 2x'
