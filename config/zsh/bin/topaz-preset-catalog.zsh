...
topaz_transform_preset_rows() {
  ...
  print -r -- $'[Cleanup] Proteus Compression Cleanup\tCleanup\tproteus-compression-cleanup\ttvai_up=model=prob-4:scale=1:preblur=0.02:noise=0.20:details=0.22:halo=-0.08:blur=0.16:compression=0.62:estimate=8:grain=0.01:gsize=2:device=0:vram=0.95:instances=1\tvideoai=[Cleanup] Proteus Compression Cleanup'
  print -r -- $'[Denoise] Nyx Dark Footage\tDenoise\tnyx-denoise-dark-footage\ttvai_up=model=nyx-3:scale=1:preblur=0:noise=0.80:details=0.25:halo=0:blur=0.20:compression=0.25:estimate=8:grain=0:gsize=2:device=0:vram=0.95:instances=1\tvideoai=[Denoise] Nyx Dark Footage'
  print -r -- $'[Enhance] Iris MQ, Sharpen\tEnhance\tiris-mq-enhance-sharpen\ttvai_up=model=iris-mq:scale=1:preblur=0:noise=0.25:details=0.50:halo=0:blur=0.15:compression=0.20:estimate=8:grain=0.01:gsize=2:device=0:vram=0.95:instances=1\tvideoai=[Enhance] Iris MQ, Sharpen'
  print -r -- $'[Focus Fix] Proteus Light\tFocus Fix\tproteus-focus-fix-light\ttvai_up=model=prob-4:scale=1:preblur=0:noise=0.15:details=0.55:halo=0.04:blur=0.18:compression=0.12:estimate=8:grain=0.01:gsize=2:device=0:vram=0.95:instances=1\tvideoai=[Focus Fix] Proteus Light'
  print -r -- $'[Focus Fix] Proteus Strong\tFocus Fix\tproteus-focus-fix-strong\ttvai_up=model=prob-4:scale=1:preblur=0:noise=0.22:details=0.80:halo=0.08:blur=0.28:compression=0.18:estimate=8:grain=0.01:gsize=2:device=0:vram=0.95:instances=1\tvideoai=[Focus Fix] Proteus Strong'
  print -r -- $'[Interpolate] Apollo 60fps\tInterpolate\tapollo-interpolate-60fps\ttvai_fi=model=apollo:slowmo=1:rdt=0.01:fps=60:device=0:vram=0.95:instances=1\tvideoai=[Interpolate] Apollo 60fps'
  print -r -- $'[Interpolate] Chronos Fast 60fps\tInterpolate\tchronos-fast-interpolate-60fps\ttvai_fi=model=chf-3:slowmo=1:rdt=0.01:fps=60:device=0:vram=0.95:instances=1\tvideoai=[Interpolate] Chronos Fast 60fps'
  print -r -- $'[Upscale] Proteus 2x, Sharpen\tUpscale\tproteus-upscale-2x-sharpen\ttvai_up=model=prob-4:scale=2:preblur=0:noise=0.18:details=0.35:halo=0.02:blur=0.10:compression=0.12:estimate=8:grain=0.01:gsize=2:device=0:vram=0.95:instances=1\tvideoai=[Upscale] Proteus 2x, Sharpen'
  print -r -- $'[Upscale] Proteus 4K, Grain, Sharpen\tUpscale\tproteus-4k-grain-sharpen\ttvai_up=model=prob-4:scale=0:w=3840:h=2160:preblur=0:noise=0.10:details=0.38:halo=-0.04:blur=0.18:compression=0.20:estimate=8:grain=0.03:gsize=2:device=0:vram=0.95:instances=1,scale=w=3840:h=2160:flags=lanczos:threads=0\tvideoai=[Upscale] Proteus 4K, Grain, Sharpen'
  print -r -- $'[Upscale] Starlight Mini 2x\tUpscale\tstarlight-mini-upscale-2x\ttvai_up=model=slm-1:scale=2:device=0:vram=0.95:instances=1\tvideoai=[Upscale] Starlight Mini 2x'
  print -r -- $'[Upscale, Interpolate] Proteus 2x, Chronos Fast 60fps\tUpscale, Interpolate\tproteus-upscale-2x-sharpen-chronos-fast-60fps\ttvai_up=model=prob-4:scale=2:preblur=0:noise=0.18:details=0.35:halo=0.02:blur=0.10:compression=0.12:estimate=8:grain=0.01:gsize=2:device=0:vram=0.95:instances=1,tvai_fi=model=chf-3:slowmo=1:rdt=0.01:fps=60:device=0:vram=0.95:instances=1\tvideoai=[Upscale, Interpolate] Proteus 2x, Chronos Fast 60fps'
  print -r -- $'[Upscale, Interpolate] Proteus 4K, Apollo 60fps\tUpscale, Interpolate\tproteus-4k-apollo-60fps\ttvai_up=model=prob-4:scale=0:w=3840:h=2160:preblur=0:noise=0.10:details=0.38:halo=-0.04:blur=0.18:compression=0.20:estimate=8:grain=0.03:gsize=2:device=0:vram=0.95:instances=1,tvai_fi=model=apollo:slowmo=1:rdt=0.01:fps=60:device=0:vram=0.95:instances=1,scale=w=3840:h=2160:flags=lanczos:threads=0\tvideoai=[Upscale, Interpolate] Proteus 4K, Apollo 60fps'
}
