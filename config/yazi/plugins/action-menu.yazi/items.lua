...
return { groups = {
	...
	},
	{
		...
		{ desc = "60fps resolve: optical flow, enhanced better, wide", run = kitty("--window --hold", "resolve 60fps enhanced better wide", BIN .. "interpolate-resolve --quality enhanced-better --range wide %s"), orphan = true },
		{ desc = "60fps resolve: optical flow, enhanced faster, medium", run = kitty("--window --hold", "resolve 60fps enhanced faster", BIN .. "interpolate-resolve --quality enhanced-faster --range medium %s"), orphan = true },
		{ desc = "60fps resolve: optical flow, speed warp better, medium", run = kitty("--window --hold", "resolve 60fps speed warp better", BIN .. "interpolate-resolve --quality speed-warp-better --range medium %s"), orphan = true },
		{ desc = "60fps resolve: optical flow, speed warp metal, medium", run = kitty("--window --hold", "resolve 60fps speed warp metal", BIN .. "interpolate-resolve --quality speed-warp-metal --range medium %s"), orphan = true },
		{ desc = "60fps resolve: optical flow, speed warp metal, wide", run = kitty("--window --hold", "resolve 60fps speed warp metal wide", BIN .. "interpolate-resolve --quality speed-warp-metal --range wide %s"), orphan = true },
