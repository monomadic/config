...
-- this host. It names its source purely through job-runner's $TARGET_FILE
...
-- and on any render machine (job-runner sets TARGET_FILE and executes it in
...
local function write_job_file(plan, dir)
    ...
    f:write(": \"${TARGET_FILE:?run me through job-runner, or set TARGET_FILE}\"\n")
