...
mp.add_key_binding(nil, "smart-back", smart_back)
mp.add_key_binding(nil, "smart-forward", smart_forward)
mp.add_key_binding(nil, "playlist-prev-track", play_previous_entry)
mp.add_key_binding(nil, "playlist-next-track", play_next_entry)
mp.add_key_binding(nil, "smart-random-position", random_chapter_or_seek)
mp.add_key_binding(nil, "playlist-random-track", random_playlist_entry)
