...
<dict>
	...
	<array>
		<string>$HOME/.local/bin/motherfucker</string>
	</array>
	...
	<dict>
		<key>PATH</key>
		<string>$HOME/.local/bin:$HOME/.cargo/bin:/opt/homebrew/bin:/usr/bin:/bin:/usr/sbin:/sbin</string>
	</dict>
	<key>RunAtLoad</key>
	<true/>
	<key>KeepAlive</key>
...
echo "installed: $HOME/.local/bin/motherfucker"
