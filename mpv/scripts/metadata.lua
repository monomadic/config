-- metadata.lua
-- usage: a script-message-to filehud toggle
-- 
local mp = require "mp"
...
-- Toggle message (script-message-to <scriptname> toggle)
mp.register_script_message("toggle", function()
    enabled = not enabled
    mp.osd_message("File HUD: " .. (enabled and "ON" or "OFF"), 1.2)
    draw_hud()
end)-- Toggleable file HUD (default: enabled)
local mp = require "mp"
local enabled = true  -- start ON
